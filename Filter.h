...
__global__ void Generate_NDVI_reference(float cosyear, float *img_NDVI, float *img_QA, int n_X, int n_Y, int n_B, int n_Years, float *NDVI_reference, float *d_res_3, int *d_res_vec_res1);
